...
function generateStartScreenTemplate() {
...
//             <input type="submit" value="Submit Answer" aria-lable="Submit Answer"/>
//         </form>`;
//  }
...
function render() {
    // render should hide start-screen, 
    if(!STORE.quizStarted) {
        // show start page 
        $('main').html(generateStartScreenTemplate());
